# QuickSnipe - macOS Clipboard Manager
# Makefile for building, testing, and distributing QuickSnipe
...
TEST_BUNDLE_IDENTIFIER ?= com.nissy.QuickSnipeTests
...
help: ## Show this help message
	@echo "$(BLUE)QuickSnipe Makefile$(NC)"
	@echo ""
...
test-specific: generate ## Run specific test (use TEST=ClassName)
	...
	xcodebuild test \
		...
		CODE_SIGNING_REQUIRED=NO \
		CODE_SIGNING_ALLOWED=NO \
		-only-testing:QuickSnipeTests/$(TEST)
